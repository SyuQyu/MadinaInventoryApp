import { IonContent, IonInput, IonRouterLink, IonTextarea, IonToast } from '@ionic/react';
  ...
  return (
    <IonContent fullscreen={false}>
      <div className='md:px-10 md:py-10 px-2 py-5 w-full h-full flex flex-col'>
        ...
        <div className='w-full rounded-md border border-slate-400 mb-6 p-4 flex flex-col justify-between gap-4 items-center'>
